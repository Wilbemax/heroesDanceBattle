...
const sendToBattleButton = document.querySelector('#sendToBattleButton')
const doSkillButton = document.querySelector('#doSkillButton')
const getEnemyButton = document.querySelector('#getEnemyButton')
